...
public final class PlayerTradeRemoveItemEvent extends WorldItemTradeEvent {
    private final PlayerTrade trade;
    private final PlayerTrader trader;

    public PlayerTradeRemoveItemEvent(PlayerTrade trade, PlayerTrader trader, WorldItem item) {
        super(item);
        this.trader = trader;
        this.trade = trade;
    }
